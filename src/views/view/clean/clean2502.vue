      ...
      gifts: [
        {
          ...
          image: '24spring_clean/images/2502/sp1-1.png'
        },
        {
          url: 'https://www.tk3c.com/dic2.aspx?cid=111723&aid=23099&hid=124107&strPreView=y',
          image: '24spring_clean/images/2502/sp1-2.png'
        },
      ],
        ...
        <ul class="gap:10">
          <li v-for="gift in gifts">
            <a :href="$filters.addGALink(gift.url)" target="_blank">
              <img :src="$filters.siteUrl(gift.image)"/></a>
          </li>
        </ul>
      </div>
    </section>
      ...
      <div class="content">
        ...
        <div class="box" v-for="(tab, t) in tabs" v-show="statusTab == t">
          ...
          <a class="more" :href="$filters.addGALink(tab.url)" target="_blank">
            <img :src="$filters.siteUrl('24spring_clean/images/2412/more.png')" />
          </a>
        </div>
      </div>
    </section>
...
$dir: 'https://events.cdn-tkec.tw/events_net/events_net/24spring_clean/images/2502/';
$origin: 'https://events.tk3c.com/events_net/events_net/24spring_clean/images/2502/';
...
@include media-query('mobile', '576px') {
  ...
  .background2 {
    ...
    background-position: -40vw 0,top;
  }
