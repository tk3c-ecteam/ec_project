      ...
      bank2After1213:[
         {
          date: '2024/12/13-31',
            alertText: ` <ul style='text-align:left;'>
             ...
             <li style='margin-bottom:10px;'>於活動期間(2024/12/13-2024/12/31)於燦坤實體門市或燦坤線上購物網站購買全館商品，除享有「促銷價」的折扣外，刷「星展銀行信用卡」，單筆分期刷滿20,000元(限分3、6、8期，再享分期0%利率)，可享現折800元的優惠，單張發票不累贈，最多折抵一次，總限量1,000名。</li>
                <li style='margin-bottom:10px;'>(1)燦坤實體門市：結帳時須出示「燦坤振興_星展銀行分期現折800元券(APP)」(取得方式請見第2點說明)，憑券兌換現折800元，限量兌換900名，每位會員及每張星展銀行信用卡限回饋2次。</li>
