      ...
      tab1: [
        {
          0: [
            {
              menu: 4423,
              title: 'icewash2209/images/2411/sb4.png',
          ...
          1: [
            {
              menu: 5540,
              title: 'icewash2209/images/2411/sb5.png',
              url: 'https://www.tk3c.com/dic1.aspx?cid=12504&aid=4878'
            }
          ],
          2: [
          ...
          4: [
            {
              menu: 7085,
              title: 'icewash2209/images/2411/sb8.png',
      ...
      tab2: [
        {
          ...
          4: [
            {
              menu: 6024,
              title: 'icewash2209/images/2411/sb9.png',
          ...
          5: [
            {
              menu: 3651,
              title: 'icewash2209/images/2411/sb10.png',
...
<template>
  <div id="icewash-container" v-cloak>
    <div class="background">
      <h2 class="title">
        <img :src="$filters.siteUrl('icewash2209/images/2411/title2.png')" alt="感恩冰洗賞" />
      </h2>

      <h5 class="subtitle">
        <img :src="$filters.siteUrl('icewash2209/images/2411/subtitle.png')" alt="感恩冰洗賞" />
      </h5>
        ...
        <ul class="gift w:90% w:95vw@<992 w:full@<576 rel m:auto">
          <li>
            <a
              ...
              "
              target="_blank"
              ><img :src="$filters.siteUrl('icewash2209/images/2411/S01-1.png')"
            /></a>
          </li>
          <li>
            <a
              ...
              target="_blank"
              ><img :src="$filters.siteUrl('icewash2209/images/2411/S01-2.png')"
            /></a>
          </li>
        </ul>

        <div class="sec w:80% w:85vw@<992 w:95vw@<576 m:auto rel">
          <swiper
            :loop="false"
            :autoplay="{
              delay: 1600,
          ...
          >
            <swiper-slide>
              <a
                ...
                target="_blank"
                ><img :src="$filters.siteUrl('icewash2209/images/2411/S01-3.png')"
              /></a>
            </swiper-slide>
            <swiper-slide>
              <a
                ...
                target="_blank"
                ><img :src="$filters.siteUrl('icewash2209/images/2411/S01-4b.png')"
              /></a>
            </swiper-slide>
            <swiper-slide>
              <div class="flex flex-direction:row">
                <a
                  :href="$filters.addGALink('https://www.tk3c.com/dic1.aspx?cid=111723&aid=22875')"
                  target="_blank"
                  ><img :src="$filters.siteUrl('icewash2209/images/2411/S01-5.png')"
                /></a>
                <a
                  :href="$filters.addGALink('https://www.tk3c.com/dic1.aspx?cid=119202&aid=23268')"
                  target="_blank"
                  ><img :src="$filters.siteUrl('icewash2209/images/2411/S01-6.png')"
                /></a>
              </div>
            </swiper-slide>
          </swiper>
    ...
    <section class="sub-box">
      <h2 class="title">
        <img :src="$filters.siteUrl('icewash2209/images/2411/S02.png')" alt="" />
      </h2>
      <ul class="gap:10">
        <li class="alert1 w:40% w:43vw@<992 w:90vw@<576">
          <a @click="message(1)"
            ><img :src="$filters.siteUrl('icewash2209/images/2411/C1.png')" alt=""
          /></a>
        </li>
    ...
    <section class="info-box" id="info">
      <div class="flex flex-wrap:wrap gap:20 gap:10@<576 m:auto jc:center">
        <div class="w:40% w:45vw@<992 m:0|0 m:0|0|3%@<576">
          <img class="mb:2%" :src="$filters.siteUrl('icewash2209/images/2411/info1.png')" alt="" />
          <a
        ...
        <div class="w:40% w:45vw@<992 m:0|0 m:0|0|3%@<576">
          <img class="mb:2%" :src="$filters.siteUrl('icewash2209/images/2411/info2.png')" alt="" />
          <a
            class="brightness(0.7) brightness(1).active"
...
$dir: 'https://events.cdn-tkec.tw/events_net/events_net/icewash2209/images/2411/';
$origin: 'https://events.tk3c.com/events_net/events_net/icewash2209/images/2411/';
