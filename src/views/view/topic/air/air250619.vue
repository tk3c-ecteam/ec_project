<template>
  <Template618 :contents="contents">
    ...
    <template #items>
      <p class="items i1">
        <img :src="$filters.siteUrl('airconditioner/images/item1.png')" />
      </p>
      <p class="items i2">
        <img :src="$filters.siteUrl('airconditioner/images/item3.png')" />
      </p>
      <p class="items i3">
        <img :src="$filters.siteUrl('airconditioner/images/item2.png')" />
      </p>
    </template>
    
    <template #special>
      <swiper-slide v-for="(sp,s) in contents[0].specials" class="w:18.3%! w:31.2%!@<992 w:47%!@<576" :key="s">
    ...
    <template #content>
          ...
          <ul class="tab">
            <swiper id="infoTab" :space-between="10" :breakpoints="{
              ...
              <swiper-slide v-for="(info, i) in infos[0]" :class="[statusInfo == i ? 'active' : '']"
                @click="goSlide(i)" class="contrast(0.5) contrast(1).active">
                <a @click="changeInfo(i)"><img :src="$filters.siteUrl(info[0].tab)" alt="" /></a>
              </swiper-slide>
            </swiper>
          </ul>
          <img class="w:full hidden@<992 abs left:0 right:0 m:auto top:10% z:-1" :src="$filters.siteUrl('airConditionerLAB/images/2402/b_bg.png')" />
          <div class="move-area">
      ...
      <section class="info2-box">
        <div class="description">
          <p class="w:90% w:full@<992 m:1%|auto|2%">
          ...
          <a class="w:50% w:80%@<992" @click="message(4)"><img :src="$filters.siteUrl('airConditionerLAB/images/2402/c_bn.png')" />
          </a>
        </div>
