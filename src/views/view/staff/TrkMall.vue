...
const contents = [
  {
    ...
    floor: [
      {
        text: '手機',
        image: 'trkmall/images/s1.png'
      },
      {
        text: '平板',
        image: 'trkmall/images/s2.png'
      },
      {
        text: 'WATCH',
        image: 'trkmall/images/s3.png'
      },
       {
        text: '咖啡機',
        image: 'trkmall/images/s4.png',
        type:listM
      }
    ],
    alertHtml: `
...
<template>
  ...
  <!-- 活動辦法 -->
  <section class="info-group" id="info">
...
$dir: 'https://events.cdn-tkec.tw/events_net/events_net/trkmall/images/';
$origin: 'https://events.tk3c.com/events_net/events_net/trkmall/images/';
