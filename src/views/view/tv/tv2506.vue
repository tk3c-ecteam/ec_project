  ...
  <div id="tv-container">
    ...
    <section class="gift-box">
      ...
      <a class="w:80% w:90%@<992 w:full@<576" :href="$filters.addGALink('https://www.tk3c.com/dictitleurl.aspx?cid=11312')" target="_blank">
          <img :src="$filters.siteUrl('TV/images/gift_test.png')" />
        </a>
    </section>
    ...
    <section class="home-box scroll" titles="房東精選" id="home" v-show="isHome">
      <h2 class="title">
        <img :src="$filters.siteUrl('TV/images/S01.png')" />
      </h2>
    ...
    <section class="discount-box" titles="領券再現折" id="dis" v-if="isDis && product2[menuDis] != ''">
      <h2 class="title">
        <img :src="$filters.siteUrl('TV/images/S02.png')" />
      </h2>
    ...
    <section class="sale-group scroll" titles="福利品出清" id="sale">
      <h2 class="title">
        <img :src="$filters.siteUrl('TV/images/S03.png')" />
      </h2>
    ...
    <section class="night-box" v-show="isNight && products[menuNight[n]] != ''">
      <h2 class="title">
        <a class="more" :href="$filters.addGALink('https://events.tk3c.com/events_net/nightsale/index.html')"
          target="_blank">
          <img :src="$filters.siteUrl('TV/images/S04.png')" />
        </a>
      </h2>
    ...
    <section class="brand-group scroll" titles="人氣大牌" id="brand">
      <h2 class="title">
        <img :src="$filters.siteUrl('TV/images/S05.png')" />
      </h2>
