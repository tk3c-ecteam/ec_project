<template>
  <div id="tv-container">
    ...
    <section class="discount-box" id="dis" v-if="isDis">
      ...
      <div class="discount">
        <JimmyFloor :id="4328" :isSwiper="1" :name="'dis'"></JimmyFloor>
    ...
    <section class="sale-group scroll" titles="品牌福利出清" id="sale">
      ...
      <div class="content">
        <Tabs :isSwiper="1" :tabs="saleTab" :statusSelect="2">
    ...
    <!-- 其他樓層 -->
    <CommonFloor2 :floors="floorImg" :num="7"></CommonFloor2>
  </div>

  <!-- 左側選單+手機版 -->
  <LeftAside v-model:asides="asides"></LeftAside>

  <!-- 右側選單 -->
  <RightAside v-model:asides="asides"></RightAside>
</template>
