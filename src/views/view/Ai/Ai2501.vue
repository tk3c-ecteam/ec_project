  ...
  <div id="ai-container">
    <div class="background">
      <h2 class="title animate__animated animate__lightSpeedInLeft">
        <img :src="$filters.siteUrl('2024083C/images/2501/title2.png')" />
      </h2>

      <div class="product">
        <swiper :loop="true" :effect="'fade'" :parallax="true" :autoplay="{ delay: 1800, disableOnInteraction: false }"
    ...
    <section class="gift-box">
      ...
      <ul class="tab m:0|auto|1% m:0|auto|2%@<992 gap:20 gap:15@<576">
        <li :class="[statusGift == 0 ? 'active' : '']" :value="statusGift"
          class="w:34% w:45vw@<992 w:80vw@<576 brightness(0.7) brightness(1).active">
          <a @click="changeGift(0)">
            <img :src="$filters.siteUrl('2024083C/images/2412/tab1.png')" /></a>
        </li>
        <li class="w:32% w:45vw@<992 w:80vw@<576 brightness(0.7) brightness(1).active"
          :class="[statusGift == 1 ? 'active' : '']" :value="statusGift">
          <a @click="changeGift(1)">
            <img :src="$filters.siteUrl('2024083C/images/2412/tab2.png')" /></a>
        </li>
      </ul>
    ...
    <div class="pro-group">
      <div>
        ...
        <section class="products scroll" v-for="(tab, t) in tabs"
          :class="[statusGift == 0 ? `tab${Number(t) + 1}-box` : `tab${Number(t) + 7}-box`]"
          :id="[statusGift == 0 ? `tab${Number(t) + 1}` : `tab${Number(t) + 7}`]">
          <h2 class="title">
            <a v-if="tab[0].content != undefined" :href="[tab[0].content[0].url != undefined ? $filters.addGALink(tab[0].content[0].url) : $filters.addGALink(tab[0].url)]" target="_blank">
              <img :src="$filters.siteUrl(tab[0].title)" />
            </a>
            <a v-else :href="$filters.addGALink(tab[0].url)" target="_blank">
              <img :src="$filters.siteUrl(tab[0].title)" />
            </a>
          </h2>
...
export default {
  ...
  data() {
    return {
      ...
      pro: [
        {
          ...
          image: '2024083C/images/2501/245519.png'
        },
         {
          url: 'https://www.tk3c.com/pt.aspx?pid=246709',
          image: '2024083C/images/2501/246709.png'
        },
         {
          url: 'https://www.tk3c.com/pt.aspx?pid=252609',
          image: '2024083C/images/2501/252609.png'
        }
      ],
      gifts: [
        {
      ...
      sales: [
        {
          image: '2024083C/images/2501/D01-4.jpg',
        },
        {
  ...
  methods: {
    ...
    changeGift(id) {
      ...
      setTimeout(() => {this.statusGift == 0 ? (this.tabs = this.tab1[0]) : (this.tabs = this.tab2[0])
      }, 20);
    },
    change(id) {
      if (event) {
...
<style lang="scss">
@charset "utf-8";
$dir: 'https://events.cdn-tkec.tw/events_net/events_net/2024083C/images/2501/';
$origin: 'https://events.tk3c.com/events_net/events_net/2024083C/images/2501/';
...
@include media-query('mobile', '992px') {
  #ai-container {
    .background {
      ...
      background-position: -3vw 4vw,top;
      padding-bottom: 55vw;
      .title {
        width: 45%;
        left: 6%;
