        ...
        <a class="bg:#e249fe r:20px color:#fff color:#fff:hover box:border-box f:2em f:1.5em@<576 w:20% w:35%@<992 w:50%@<576 m:auto" @click="showMsg(1)">
         ...
         <AlertBox ref="alert1" :type="'text'">
          ...
          <ul>
             ...
             <li>2.得獎名單將於2025/6/15公布於FACEBOOK粉絲專頁「燦坤線上購物」(<a class="color:blue text:underline" href="https://www.facebook.com/TDdd331" target="_blank">https://www.facebook.com/TDdd331</a>) 並另以簡訊通知中獎者，通知以會員資料所留存的個人聯絡資料為準。倘中獎人因個人因素致無法收受上開通知(如無法收受、未能讀取或遲誤讀取)，均與燦坤3C無涉。​</li>
      ...
      <div class="t2 tab-content pt:2% pt:3%@<992 box:border-box" v-show="statusGift == 1">
        ...
        <ul>
          ...
          <ul>
             <li>1.請留意登記完成不代表保證獲得回饋(抽獎)資格，燦坤3C後續會進行資格檢核，相關認定以燦坤3C電腦系統之紀錄與認定為準。​</li>
             <li>2.消費金額以實際發票開立金額認定，僅限活動指定商品消費金額，其他商品恕不累計。​</li>
             <li>3.得獎名單將於2025/6/15公布於FACEBOOK粉絲專頁「燦坤線上購物」(<a class="color:blue text:underline" href="https://www.facebook.com/TDdd331" target="_blank">https://www.facebook.com/TDdd331</a>) 並另以簡訊通知中獎者，通知以會員資料所留存的個人聯絡資料為準。倘中獎人因個人因素致無法收受上開通知(如無法收受、未能讀取或遲誤讀取)，均與燦坤3C無涉。​</li>
