<template>
  <div id="ai-container">
    <div class="background">
      <h2 class="title">
        <img :src="$filters.siteUrl('2024083C/images/2503/title.png')" />
      </h2>
      <p class="product animate__animated animate__fadeInRight">
        <img :src="$filters.siteUrl('2024083C/images/2503/kv_pd.png')" />
      </p>
    </div>


    <p class="item right b1">
      <img :src="$filters.siteUrl('2024083C/images/2503/Butterfly01.png')" />
    </p>
    <p class="item left b2">
      <img :src="$filters.siteUrl('2024083C/images/2503/Butterfly02.png')" />
    </p>
    <p class="item right b3">
      <img :src="$filters.siteUrl('2024083C/images/2503/Butterfly03.png')" />
    </p>

    <!--  指南 -->
    <section class="gift-box">
      <h2 class="title">
        <img :src="$filters.siteUrl('2024083C/images/2503/sp-bar.png')" />
      </h2>
      ...
      <ul class="w:45% w:60%@<992 w:95%@<576 grid-cols:2 m:0|auto|1% m:0|auto|2%@<992 gap:10 gap:5@<576">
        <li :class="[statusGift == 0 ? 'active' : '']" class="contrast(0.5) contrast(1).active">
          <a @click="changeGift(0)">
            <img :src="$filters.siteUrl('2024083C/images/2503/bn_sp01.png')" /></a>
        </li>
        <li class="contrast(0.5) contrast(1).active" :class="[statusGift == 1 ? 'active' : '']">
          <a @click="changeGift(1)">
            <img :src="$filters.siteUrl('2024083C/images/2503/bn_sp02.png')" /></a>
        </li>
      </ul>

      <!-- 筆電 -->
      <div class="tab-content rel" v-if="statusGift == 0">
        <img class="hidden@<576 abs w:full h:auto left:0 right:0 m:auto top:0 z:-1"
            ...
            <div class="flex flex-direction:row gap:10 mb:1%">
              ...
              <a class="w:52% w:full@<576"
                :href="$filters.addGALink('https://events.tk3c.com/events_net/RTXNB/index.html')" target="_blank"><img
                  :src="$filters.siteUrl('2024083C/images/2503/sp01-3a.png')" /></a>
            </div>
            <a class="w:full" :href="$filters.addGALink('https://www.tk3c.com/events/eventgift.aspx')"
              target="_blank"><img :src="$filters.siteUrl('2024083C/images/2503/sp01-4a.png')" /></a>
          </li>
          <li class="w:20.5% w:19.5%@<992 w:full@<576 flex flex-direction:column  flex-direction:row@<576 gap:10">
            <a :href="$filters.addGALink('https://www.tk3c.com/dic2.aspx?cid=11124&aid=22469&hid=121988')"
              target="_blank"><img :src="$filters.siteUrl('2024083C/images/2503/sp01-5a.png')" /></a>
            <a :href="$filters.addGALink('https://www.tk3c.com/dic2.aspx?cid=11124&aid=22469&hid=121986')"
              target="_blank"><img :src="$filters.siteUrl('2024083C/images/2503/sp01-6b.png')" /></a>
            <a :href="$filters.addGALink('https://www.tk3c.com/dic2.aspx?cid=11124&aid=22469&hid=121987')"
              target="_blank"><img :src="$filters.siteUrl('2024083C/images/2503/sp01-7a.png')" /></a>
          </li>
        </ul>
        <a class="bg:#000 r:20px color:#fff box:border-box f:2em f:1.5em@<576 w:20% w:35%@<992 w:50%@<576 m:auto" @click="alert(1)">
          活動辦法
        </a>
      </div>
      ...
      <div class="tab-content rel" v-if="statusGift == 1">
        <img class="hidden@<576 abs w:full h:auto left:0 right:0 m:auto top:0 z:-1"
          :src="$filters.siteUrl('2024083C/images/2503/sp_bg.png')" />
        <ul class="gap:10 mb:2% pt:8% box:border-box">
          <li class="rel w:81% w:81%@<992 w:full@<576">
            <a @click="goNB('#tab8')">
              <img :src="$filters.siteUrl('2024083C/images/2503/sp01-8.png')" />
            </a>
          </li>
          <li class="w:40% w:48%@<576">
            <a @click="goNB('#tab9')" class="mb:2%@<576">
              <img :src="$filters.siteUrl('2024083C/images/2503/sp01-9.png')" />
            </a>
          </li>
          <li class="w:40% w:48%@<576">
            <a @click="goNB('#tab13')" class="mb:2%@<576">
              <img :src="$filters.siteUrl('2024083C/images/2503/sp01-10.png')" />
            </a>
          </li>
        </ul>
        <a @click="alert(2)" class="f:2em f:1.5em@<576 bg:#000 r:20px color:#fff box:border-box w:20% w:35%@<992 w:50%@<576 m:auto">
          活動辦法
        </a>
      </div>
    </section>
...
<style lang="scss">
@charset "utf-8";
$dir: 'https://events.cdn-tkec.tw/events_net/events_net/2024083C/images/2503/';
$origin: 'https://events.tk3c.com/events_net/events_net/2024083C/images/2503/';
...
#ai-container {
  ...
  .background {
    width: 100%;
   $image: $dir + 'kv_bg.png';
    @include bg-responsive($image, 2000, 1170);
    position: relative;
    margin: 0 auto 0;
...
.pro-group {
  ...
  .bg01 {
    border-radius: 20px;
    box-shadow: 4px 3px 22px 11px rgb(247 247 247);
    padding: 1%;
    margin: 0 auto 0;
    box-sizing: border-box;
  }
...
@include media-query('mobile', '576px') {
  ...
  #ai-container {
    .background {
      ...
      background-position: -101vw 5.5rem,top;
