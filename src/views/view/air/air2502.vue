<template>
  <div id="air-container" v-cloak>
    <div class="background">
      <h2 class="title">
        <img class="pc" :src="$filters.siteUrl('airConditionerLAB/images/2502/title.png')" alt=" " />
         <img class="mobile" :src="$filters.siteUrl('airConditionerLAB/images/2502/title_m.png')" alt=" " />
      </h2>
    ...
    <section class="discount-box" id="dis" v-if="isDis && product2[menuDis] != ''">
      <h2 class="title">
        <a :href="$filters.addGALink(disUrl)" target="_blank">
          <img :src="$filters.siteUrl('airConditionerLAB/images/2502/S1.png')" alt="" />
        </a>
      </h2>
      ...
      proAir: [
        {
          ...
          image: 'airConditionerLAB/images/2502/216180.png'
        },
         {
          url: 'https://www.tk3c.com/pt.aspx?pid=236926',
          image: 'airConditionerLAB/images/2502/236926.png'
        },
         {
          url: 'https://www.tk3c.com/pt.aspx?pid=247438',
          image: 'airConditionerLAB/images/2502/247438.png'
        }
      ],
      specials: [
        {
          ...
          0: [
            {
              ...
              content: [
                {
                  image: 'airConditionerLAB/images/2502/s6-1.png',
                  menu: 4288
                },
                {
                  image: 'airConditionerLAB/images/2502/s6-2.png',
                  menu: 4289
                },
                {
                  url: 'https://www.tk3c.com/dic1.aspx?cid=11225&aid=4704&strPreView=y',
                  image: 'airConditionerLAB/images/2502/s6-3.png',
                  menu: 4290
                },
                {
                  image: 'airConditionerLAB/images/2502/s6-4.png',
                  menu: 4291
                }
              ]
            }
...
<style lang="scss">
   @charset "utf-8";
$dir: "https://events.cdn-tkec.tw/events_net/events_net/airConditionerLAB/images/2502/";
$origin: "https://events.tk3c.com/events_net/events_net/airConditionerLAB/images/2502/";
...
#air-container {
  ...
  .background {
     $image: $dir + 'kv.jpg';
    @include bg-responsive($image, 2000, 1000);
    position: relative;
    margin: 0 auto 0;
    background-position:
      0 45px,
    ...
    .title {
      ...
      top: 12%;
      margin: 0 auto;
      animation: bg-wave1 1.7s linear;
    }
    .subtitle {
      width: 30%;
      position: absolute;
